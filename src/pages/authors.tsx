...
export default function AuthorsPage() {
  const { authors, loading, error, deleteAuthor, refresh, isFavorite, toggleFavorite } = useAuthors();
    ...
    <main className="min-h-screen p-6 sm:p-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/favoritos"
            className="inline-flex items-center justify-center px-4 py-2 rounded-md bg-yellow-500 hover:bg-yellow-600 text-black"
          >
            Ver favoritos
          </Link>
          <button
